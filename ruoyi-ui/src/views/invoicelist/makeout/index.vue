    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="invoice"
          v-hasPermi="['system:post:makeout']"
        >开票审核</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订单类型" prop="ddlx">
          <el-input v-model="form.ddlx" placeholder="请输入订单类型" />
        </el-form-item>
        <el-form-item label="价目表" prop="jmb">
          <el-input v-model="form.jmb" placeholder="请输入价目表" />
        </el-form-item>
        <el-form-item label="销售员" prop="xys">
          <el-input v-model="form.xsy" placeholder="请输入销售员" />
        </el-form-item>
        <el-form-item label="销售类型" prop="xslx">
          <el-input v-model="form.xslx" placeholder="请输入销售类型" />
        </el-form-item>
        <el-form-item label="收款类型" prop="sklx">
          <el-input v-model="form.sklx" placeholder="请输入收款类型" />
        </el-form-item>
        ...
        <el-form-item label="发票代码" prop="fpdm">
          <el-input v-model="form.fpdm" placeholder="请输入发票代码" />
        </el-form-item>
        ...
        <el-form-item label="价格" prop="jg">
          <el-input v-model="form.jg" placeholder="请输入价格" />
        </el-form-item>
        <el-form-item label="服务起始日" prop="fwqsr">
          <el-input v-model="form.fwqsr" placeholder="请输入服务起始日" />
        </el-form-item>
        <el-form-item label="服务结束日" prop="fwjsr">
          <el-input v-model="form.fwjsr" placeholder="请输入服务结束日" />
        </el-form-item>
        <el-form-item label="大类" prop="dl">
          <el-input v-model="form.dl" placeholder="请输入大类" />
        </el-form-item>
        <el-form-item label="中类" prop="zl">
          <el-input v-model="form.zl" placeholder="请输入中类" />
        </el-form-item>
        <el-form-item label="小类" prop="xl">
          <el-input v-model="form.xl" placeholder="请输入小类" />
        </el-form-item>
